...
const Footer = () => {
  ...
  useEffect(() => {
    if (!isMapInitialized.current) {
      ...
      mapRef.current = leaflet.map('map').setView([12.989945520249943, 77.65241195365338], 13);
      leaflet.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png', {
        maxZoom: 19,
        attribution: '&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>'
      }).addTo(mapRef.current);

      leaflet.marker([12.989945520249943, 77.65241195365338]).addTo(mapRef.current);
