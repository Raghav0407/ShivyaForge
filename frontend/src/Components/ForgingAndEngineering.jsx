import back from '../Assets/img/13.png'
const ForgingAndEngineering = () => {
    return (
        <div className='container' style={{
            border: "2px solid orange", marginTop: "20px", backgroundImage: `url(${back})`,
            ...
            <div className='fs-5 m-4'>Having strong knowledge and experience in Commercial and Technical Areas, we are
                ...
                Customer’s Drawings and Specifications at Best Competitive Prices.</div>
        </div>
    )
}
